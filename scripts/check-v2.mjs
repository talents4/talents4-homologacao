...
const required = [...Object.keys(pages), 'documentacao.html',
  ...
  'tests/talents-sql-contract.test.mjs','tests/documentation-sql-contract.test.mjs','supabase/talents-v22/30_frontend_schema_audit.sql','supabase/talents-v22/40_harden_anon_grants.sql','supabase/talents-v22/50_crm_collaboration_scope.sql',
...
const collaborationCode = read('assets/t4-collaboration.js'), collaborationCSS = read('assets/t4-collaboration.css'), collaborationSQL = read('supabase/talents-v22/50_crm_collaboration_scope.sql');
