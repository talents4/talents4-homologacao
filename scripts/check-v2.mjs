...
check(talentsV25.includes('Relações de trabalho por Talento.') && !talentsV25.includes('Todas as seleções em aberto') && organizationV25.includes('Todas as seleções em aberto'), 'Talentos → Seleções permanece separado de Organizacional → Seleções');
