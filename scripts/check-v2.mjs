...
check(organizationCode.includes('planning-focus') && organizationCode.includes('operations-focus') && organizationCode.includes('org-priority-panel') && organizationCode.includes('historyRows') && organizationCode.includes('Histórico do mês') && organizationCode.includes('Histórico completo'), 'Planejamento e PO organizam prioridade, fila e histórico');
