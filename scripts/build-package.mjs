...
if (fs.existsSync(path.join(root, 'TALENTOS_V2_5.md'))) {
  const result = spawnSync(process.execPath, [path.join(root, 'scripts/build-talents-v25.mjs'), ...(process.argv[2] ? [process.argv[2]] : [])], { stdio: 'inherit' });
